...
<%= data.branding.codePrefix %>.AuthenticationService.AuthenticateExternal(
...
<%= data.branding.codePrefix %>->getAuthenticationService()->authenticateExternal(
    userId,
    token,
    externalAuthName,
    forceCreate,
...
<%= data.branding.codePrefix %>.getAuthenticationService().authenticateExternal(userID, token, externalAuthName, forceCreate, this);
