...
- "heartbeat" service, "READ" operation only (Note: ... ) important - heartbeats are used to keep your client sessions alive!
- "playerState" service - any operation
- "script" service - any operation... (Note: ... ) note, individual script permissions still apply
