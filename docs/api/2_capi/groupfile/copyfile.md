...
var result = await <%= data.branding.codePrefix %>.group_file_service.copy_file(group_id, file_id, version, new_tree_id, tree_version, new_filename, overwrite_if_present)
