...
ServerResponse result = await <%= data.branding.codePrefix %>.globalEntityService.getListCount(where:where);
...
var result = await <%= data.branding.codePrefix %>.global_entity_service.get_list_count(where)
