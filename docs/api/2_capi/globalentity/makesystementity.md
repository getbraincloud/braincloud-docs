...
ServerResponse result = await <%= data.branding.codePrefix %>.globalEntityService.makeSystemEntity(entityId:entityId, version:version, jsonEntityAcl:jsonEntityAcl);
...
var result = await <%= data.branding.codePrefix %>.global_entity_service.make_system_entity(entity_id, version, json_entity_acl)
