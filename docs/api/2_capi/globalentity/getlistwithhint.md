...
<PartialServop service_name="globalEntity" operation_name="GET_LIST_WITH_HINT" />
...
<%= data.branding.codePrefix %>.GlobalentityService.GetListWithHint(where, orderBy, maxReturn, hintJson, successCallback, failureCallback);
```
...
<%= data.branding.codePrefix %>.getGlobalentityService().getListWithHint(where, orderBy, maxReturn, hintJson, this);
```
...
[[<%= data.branding.codePrefix %> globalEntityService] GetListWithHint:
                        where:where
                      orderBy:orderBy
                    maxReturn:maxReturn
                     hintJson:hintJson
...
<%= data.branding.codePrefix %>.globalEntity.GetListWithHint(where, orderBy, maxReturn, hintJson, result =>
{
...
ServerResponse result = await <%= data.branding.codePrefix %>.globalEntityService.GetListWithHint(where:where, orderBy:orderBy, maxReturn:maxReturn, hintJson:hintJson);
...
<%= data.branding.codePrefix %>:getGlobalEntityService():GetListWithHint(where, orderBy, maxReturn, hintJson, callback)
```
...
var postResult = globalEntityProxy.GetListWithHint(where, orderBy, maxReturn, hintJson);
```
