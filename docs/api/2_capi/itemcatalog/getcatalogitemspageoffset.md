...
ServerResponse result = await <%= data.branding.codePrefix %>.itemCatalogService.getCatalogItemsPageOffset(context:context, pageOffset:pageOffset);
...
var result = await <%= data.branding.codePrefix %>.item_catalog_service.get_catalog_items_page_offset(context, page_offset)
