...
ServerResponse result = await <%= data.branding.codePrefix %>.userItemsService.useUserItem(itemId:itemId, version:version, newItemData:newItemData, includeDef:includeDef);
