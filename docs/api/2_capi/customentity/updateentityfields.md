...
ServerResponse result = await <%= data.branding.codePrefix %>.customEntityService.updateEntityFields(entityType:entityType, entityId:entityId, version:version, fieldsJson:fieldsJson);
