...
ServerResponse result = await <%= data.branding.codePrefix %>.customEntityService.deleteSingleton(entityType:entityType, version:version);
...
var result = await <%= data.branding.codePrefix %>.custom_entity_service.delete_singleton(entity_type, version)
