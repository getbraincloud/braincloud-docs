...
ServerResponse result = await <%= data.branding.codePrefix %>.gamificationService.readQuestsByCategory(category:category, includeMetaData:includeMetaData);
...
var result = await <%= data.branding.codePrefix %>.gamification_service.read_quests_by_category(category, include_meta_data)
