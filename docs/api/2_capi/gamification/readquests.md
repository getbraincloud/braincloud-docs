...
ServerResponse result = await <%= data.branding.codePrefix %>.gamificationService.readQuests(includeMetaData:includeMetaData);
...
<%= data.branding.codePrefix %>:getGamificationService():readQuests(includeMetaData, callback)
```
