...
ServerResponse result = await <%= data.branding.codePrefix %>.playbackStreamService.deleteStream(playbackStreamId:playbackStreamId);
...
var result = await <%= data.branding.codePrefix %>.playback_stream_service.delete_stream(playback_stream_id)
