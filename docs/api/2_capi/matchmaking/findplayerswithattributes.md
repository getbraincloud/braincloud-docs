...
ServerResponse result = await <%= data.branding.codePrefix %>.matchMakingService.findPlayersWithAttributes(rangeDelta:rangeDelta, numMatches:numMatches, jsonAttributes:jsonAttributes);
