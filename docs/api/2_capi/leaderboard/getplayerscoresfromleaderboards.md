...
```gdscript
var leaderboard_ids = [ "leaderboardId1", "leaderboardId2" ]

var result = await <%= data.branding.codePrefix %>.leaderboard_service.get_player_scores_from_leaderboards(leaderboard_ids)
