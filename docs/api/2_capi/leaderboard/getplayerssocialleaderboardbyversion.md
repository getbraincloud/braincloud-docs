...
<PartialServop service_name="leaderboard" operation_name="GET_PLAYERS_SOCIAL_LEADERBOARD_BY_VERSION" />
...
ServerResponse result = await <%= data.branding.codePrefix %>.leaderboardService.getPlayersSocialLeaderboardByVersion(leaderboardId:leaderboardId, profileIds:profileIds, versionId:versionId);
