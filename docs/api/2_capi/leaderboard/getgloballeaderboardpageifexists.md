...
<%= data.branding.codePrefix %>.LeaderboardService.GetGlobalLeaderboardPageIfExists(leaderboardId, sortOrder, startIndex, endIndex, successCallback, failureCallback);
```
...
int startIndex = 0;
int endIndex = 9;
<%= data.branding.codePrefix %>->getLeaderboardService()->getGlobalLeaderboardPageIfExists(leaderboardId, sortOrder, startIndex, endIndex, this);
```
...
[[<%= data.branding.codePrefix %> leaderboardService] getGlobalLeaderboardPageIfExists:leaderboardId
                  sortOrder:sortOrder
...
ServerResponse result = await <%= data.branding.codePrefix %>.leaderboardService.getGlobalLeaderboardPageIfExists(leaderboardId:leaderboardId, sortOrder:sortOrder, startIndex:startIndex, endIndex:endIndex);
...
var postResult = leaderboardProxy.getGlobalLeaderboardPageIfExists(leaderboardId, sortOrder, startIndex, endIndex);
