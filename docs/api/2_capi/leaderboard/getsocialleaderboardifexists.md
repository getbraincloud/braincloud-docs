...
ServerResponse result = await <%= data.branding.codePrefix %>.leaderboardService.getSocialLeaderboardIfExists(leaderboardId:leaderboardId, replaceName:replaceName);
