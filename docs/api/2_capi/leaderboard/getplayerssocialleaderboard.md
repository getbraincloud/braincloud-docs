...
<%= data.branding.codePrefix %>.LeaderboardService.GetPlayersSocialLeaderboard(leaderboardId, profileIds, successCallback, failureCallback);
```
...
<%= data.branding.codePrefix %>->getLeaderboardService()->getPlayersSocialLeaderboard(leaderboardId, profileIds, this);
```
...
[[<%= data.branding.codePrefix %> leaderboardService] getPlayersSocialLeaderboard:leaderboardId
...
ServerResponse result = await <%= data.branding.codePrefix %>.leaderboardService.getPlayersSocialLeaderboard(leaderboardId:leaderboardId, profileIds:profileIds);
