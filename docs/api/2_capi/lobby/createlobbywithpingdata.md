...
ServerResponse result = await <%= data.branding.codePrefix %>.lobbyService.createLobbyWithPingData(lobbyType:lobbyType, rating:rating, otherUserCxIds:otherUserCxIds, settings:settings, isReady:isReady, extraJson:extraJson, teamCode:teamCode);
