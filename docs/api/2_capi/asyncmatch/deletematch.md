...
ServerResponse result = await <%= data.branding.codePrefix %>.asyncMatchService.deleteMatch(ownerId:ownerId, matchId:matchId);
...
var result = await <%= data.branding.codePrefix %>.async_match_service.delete_match(owner_id, match_id)
