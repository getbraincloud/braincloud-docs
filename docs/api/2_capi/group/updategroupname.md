...
ServerResponse result = await <%= data.branding.codePrefix %>.groupService.updateGroupName(groupId:groupId, name:name);
...
<%= data.branding.codePrefix %>:getGroupService():updateGroupName(groupId, name, callback)
```
...
var result = await <%= data.branding.codePrefix %>.group_service.update_group_name(group_id, name)
