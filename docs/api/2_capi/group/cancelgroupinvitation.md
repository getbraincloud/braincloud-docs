...
<%= data.branding.codePrefix %>.Group.CancelGroupInvitation(groupId, profileId, successCallback, failureCallback);
```
...
<%= data.branding.codePrefix %>->getGroup()->cancelGroupInvitation(groupId, profileId, this);
```
...
[[<%= data.branding.codePrefix %> groupService] cancelGroupInvitation:groupId
                  profileId:profileId
...
ServerResponse result = await <%= data.branding.codePrefix %>.groupService.cancelGroupInvitation(groupId:groupId, profileId:profileId);
...
var result = await <%= data.branding.codePrefix %>.group_service.cancel_group_invitation(group_id, profile_id)
