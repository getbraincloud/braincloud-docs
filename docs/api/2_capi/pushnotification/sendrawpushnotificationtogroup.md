...
ServerResponse result = await <%= data.branding.codePrefix %>.pushNotificationService.sendRawPushNotificationToGroup(groupId:groupId, fcmContent:fcmContent, iosContent:iosContent, facebookContent:facebookContent);
