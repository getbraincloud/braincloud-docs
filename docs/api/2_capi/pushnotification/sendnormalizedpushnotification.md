...
ServerResponse result = await <%= data.branding.codePrefix %>.pushNotificationService.sendNormalizedPushNotification(profileId:toProfileId, alertContent:alertContentJson, customData:customDataJson);
