...
ServerResponse result = await <%= data.branding.codePrefix %>.pushNotificationService.sendNormalizedPushNotification(toProfileId:toProfileId, alertContentJson:alertContentJson, customDataJson:customDataJson);
