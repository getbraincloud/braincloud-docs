...
<%= data.branding.codePrefix %>.AuthenticationService.AuthenticateOculus(
...
<%= data.branding.codePrefix %>->getAuthenticationService()->authenticateOculus(
    userId,
    nonce,
    forceCreate,
    this);
...
<%= data.branding.codePrefix %>.getAuthenticationService().authenticateOculus(userId, nonce, forceCreate, this);
