...
<%= data.branding.codePrefix %>.AuthenticationService.AuthenticateTwitter(
...
<%= data.branding.codePrefix %>->getAuthenticationService()->authenticateTwitter(
...
<%= data.branding.codePrefix %>.getAuthenticationService().authenticateTwitter(twitterId, token, secret, forceCreate, this);
