...
<%= data.branding.codePrefix %>.AuthenticationService.AuthenticateGoogle(
...
<%= data.branding.codePrefix %>->getAuthenticationService()->authenticateGoogle(
...
<%= data.branding.codePrefix %>.getAuthenticationService().authenticateGoogle(googleUserId, serverAuthCode, forceCreate, this);
...
```gdscript
var google_user_id = "g123456789"
var server_auth_code = "authTokenFromGoogle"
var force_create = true

var result = await <%= data.branding.codePrefix %>.authentication_service.authenticate_google(google_user_id, server_auth_code, force_create)
