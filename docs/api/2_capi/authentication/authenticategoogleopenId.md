...
```gdscript
var google_user_account_email = "example@gmail.com"
var id_token = "authTokenFromGoogle"
var force_create = true

var result = await <%= data.branding.codePrefix %>.authentication_service.authenticate_google_open_id(google_user_account_email, id_token, force_create)
