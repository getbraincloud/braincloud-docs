...
ServerResponse result = await <%= data.branding.codePrefix %>.authenticationV2Service.resetUniversalIdPasswordWithExpiry(universalId:universalId, resetUrlTTLMinutes:resetUrlTTLMinutes);
